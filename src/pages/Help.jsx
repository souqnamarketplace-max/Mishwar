...
const faqs = [
  { q: "كيف أحجز رحلة في سيرتنا؟", a: "ابحث عن وجهتك، اختر الرحلة المناسبة، وأكمل الحجز بسهولة. يمكنك الدفع عبر المنصة بأمان." },
  { q: "هل يمكنني إلغاء حجزي؟", a: "نعم، يمكنك إلغاء الحجز قبل موعد الرحلة بساعتين على الأقل بدون رسوم إضافية." },
  { q: "كيف أصبح سائقاً في سيرتنا؟", a: "سجّل حسابك كسائق، أضف معلومات سيارتك، وانتظر التوثيق. بعدها يمكنك نشر رحلاتك." },
