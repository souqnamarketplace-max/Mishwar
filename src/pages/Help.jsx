...
//     (cash / Jawwal Pay / Reflect / bank transfer). Mishwar does NOT
...
const faqs = [
  ...
  {
    q: "كيف أدفع للسائق؟",
    a: "الدفع يتم مباشرة بينك وبين السائق — مِشوار لا يحتفظ بأموالك ولا يأخذ عمولة من الرحلة. عند الحجز اختر طريقة الدفع المناسبة (نقداً، جوال باي، ريفلكت، أو تحويل بنكي) واتفق مع السائق على التفاصيل."
  },
  {
  ...
  },
  {
    ...
    a: "السائق يحدد سعر المقعد الواحد عند نشر الرحلة. يمكنك مقارنة الأسعار واختيار الرحلة الأنسب لك. لا توجد رسوم خفية من جانب مِشوار."
  },
  {
