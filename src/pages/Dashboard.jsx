...
const chartData = [
  { name: "21 مايو", value: 320 }, { name: "22 مايو", value: 380 },
  { name: "23 مايو", value: 290 }, { name: "24 مايو", value: 450 },
  { name: "25 مايو", value: 520 }, { name: "26 مايو", value: 642 },
...
const revenueData = [
  { name: "الأسبوع 1", value: 180000 }, { name: "الأسبوع 2", value: 220000 },
  { name: "الأسبوع 3", value: 280000 }, { name: "الأسبوع 4", value: 340000 },
              ...
              <tbody>
                {recentTrips.map((trip) => (
                  <tr key={trip.id} className="border-b border-border/50 hover:bg-muted/30">
                    ...
                    <td className="p-3"><Badge className={`${statusColors[trip.status]} text-xs`}>{trip.status}</Badge></td>
                  </tr>
                ))}
              </tbody>
            </table>
