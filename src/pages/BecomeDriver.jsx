...
export default function BecomeDriver() {
  useSEO({
    title: "رفع وثائق التحقق للسائق — مشوارو",
    description: "ارفع وثائق قيادتك للحصول على شارة موثّق ✓ في مشوارو. التوثيق اختياري — يمكنك نشر الرحلات بدونه.",
  });
...
function StepIntro({ existingLicense }) {
  return (
    <div className="text-center py-4">
      ...
      <h2 className="text-2xl font-black text-foreground mb-2">رفع وثائق التحقق</h2>
